    ...
    <div class="detailstable">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            backButton.addEventListener('click', function() {
                window.location.href = 'customer_reschedule_tor_payment.php?Id=<?php echo urlencode($_GET['account_id']); ?>';
            });
        });
        </script>
...
<div class="proofpayment">
    ...
    <form action="reschedule_tor_submit_payment.php?account_id=<?php echo $account_id?>" method="post" enctype="multipart/form-data">
        <table>
            <tr>
