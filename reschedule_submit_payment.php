...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['proof_image']) && $_FILES['proof_image']['error'] == 0) {
        ...
        $query = "SELECT PROOF_ID FROM proof_of_payments WHERE PAYMENT_NUMBER = '$payment_number'";
        ...
        if ($result && $result->num_rows > 0) {
            ...
            $update_query = "UPDATE proof_of_payments 
            ...
            $update_payment_query = "UPDATE payment_interment SET STATUS = 'submitted' WHERE PAYMENT_ID = '$payment_number'";
