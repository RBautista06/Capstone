...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'IOF Payment Approved';
    ...
    $mail->AltBody = "Dear $accountName, Thank you for choosing Providence Memorial Park.";
    ...
    $mail->Body .= "<p style='color: black;'>Total Amount to Pay: $interementtotalprice</p><br>";
...
$theMessage = new SmsTextualMessage(
    ...
    text: "Dear $accountName, Your payment for the IOF has been successfully recieved, Interment is now scheduled. Please check your email for more details.",
    from: "ProvidencePark"
);
