...
$sql = "SELECT * FROM tor_proof_of_payments WHERE STATUS = 'pending'";
...
while ($row = mysqli_fetch_assoc($result)) {;
    ...
    $customerName = $customerNameRow['PAYMENT_OPTION'];
                        ...
                        echo "
                        <tr class='clickable-row' data-href='tor_proofofpaymentdetails.php?id=" . $row['PROOF_ID'] . "&account_id=" . $account_id . "&intermentid=".$row['TOR_ID']."'>
