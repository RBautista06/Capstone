...
$query1 = "SELECT * FROM proof_of_payments WHERE INTERMENT_ORDER = ?";
...
<div class="payments">
    ...
    <?php
    $query2 = "SELECT * FROM interment_forms WHERE INTERMENTFORM_ID = ?";
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo htmlspecialchars($interment1['INTERMENT_ORDER']); ?></td>
        </tr>
        <tr>
...
<script>
    ...
    document.getElementById("submitDecline").addEventListener("click", function(event) {
        ...
        var url = "reschedule_interment_declineprocess.php?action=decline" +
    ...
    function sendData(action) {
        ...
        var url = "reschedule_interment_pdfupdate.php?action=" + encodeURIComponent(action) +
                  "&intermentid=" + encodeURIComponent(intermentId) +
                  "&account_id=" + encodeURIComponent(accountId) +
                  "&frontdeskname=" + encodeURIComponent(frontdeskname);
