            ...
            <div class="details">
                <div class="payments">
                    ...
                    <label for="">
                        ...
                        <button type="button" onclick="location.href='customerintermentdetails.php?Id=<?php echo htmlspecialchars($interment['INTERMENT_ID']); ?>&account_id=<?php echo $account_id; ?>&payment_id=<?php echo htmlspecialchars($interment['PAYMENT_ID']); ?>'">
                    ...
                    <table>
                        ...
                        <tr>
                            <th style="width: 20%;">Chair Rental Quantity:</th>
                            <td><?php echo htmlspecialchars($interment1['CHAIRRENTALNUM']); ?> pc(s)</td>
                        </tr>
                        <tr>
                            <th>Tent Rental Quantity:</th>
                            <td><?php echo htmlspecialchars($interment1['TENTRENTALNUM']); ?> pc(s)</td>
                        </tr>
                        <tr>
                            <th>Interment Amount:</th>
                            <td>₱ <?php echo number_format(htmlspecialchars($interment1['INTERMENT_PRICE']), 2); ?></td>
                        </tr>
                    </table>
                ...
                <div class="proofpayment">
                    ...
                    <form action="submit_proofofpayment.php?account_id=<?php echo $account_id ?>" method="post" enctype="multipart/form-data">
                        <table>
                            <tr>
                            ...
                            <tr>
                                <th><label for="interment_order">Client Code:</label></th>
                                <td><input type="text" value="<?php echo htmlspecialchars($interment1['ACCOUNT_NUMBER']); ?>" readonly></td>
                            </tr>
                            <tr>
