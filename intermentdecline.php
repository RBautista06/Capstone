...
if ($action === 'decline') {
    ...
    $query = "UPDATE interment_forms SET STATUS = 'Declined' WHERE INTERMENTFORM_ID = $intermentId";
...
$query = "SELECT ACCOUNT_ID FROM interment_forms WHERE INTERMENTFORM_ID = $intermentId";
...
try {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'Interment Declined';
    $mail->Body    = "<h1>Dear $name,</h1><p>Your interment request has been declined. Reason: $reason</p>";
...
$theMessage = new SmsTextualMessage(
    ...
    text: "Dear $name, your interment request has been declined. Reason: $reason",
    from: "ProvidencePark"
);
