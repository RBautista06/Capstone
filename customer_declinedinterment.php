...
<?php
 ...
 ?>
    ...
    <h1><img src="pictures/declineinterment.png" alt=""></h1>
...
$sql = "SELECT * FROM interment_forms WHERE STATUS = 'Declined' AND ACCOUNT_ID = $account_id";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "
    <tr class='clickable-row' data-href='decline_intermentdetails.php?Id=" . $account_id  . "&interment_id=" . $row['INTERMENTFORM_ID'] . "'>
        ...
        <td>
    <a href='delete_interment.php?interment_id=" . $row['INTERMENTFORM_ID'] . "&account_id=" . $account_id . "' class='delete-link' onclick='return confirm(\"Are you sure you want to delete this record?\")'>Delete</a>
</td>
