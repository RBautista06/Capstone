...
$sql = "SELECT * FROM payment_interment WHERE STATUS = 'pending' AND ACCOUNT_ID = $account_id";
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    echo "
    <tr class='clickable-row' data-href='customerintermentpayment_details.php?id=" . htmlspecialchars($row['PAYMENT_ID']) . "&account_id=" .$account_id. "'>
