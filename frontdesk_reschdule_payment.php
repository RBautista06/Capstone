...
$sql = "SELECT * FROM proof_of_payments WHERE STATUS = 'reschedule payment'";
...
while ($row = mysqli_fetch_assoc($result)) {;
    ...
    $customerNameRow = mysqli_fetch_assoc($customerNameResult);
                        ...
                        echo "
                        <tr class='clickable-row' data-href='reschedulepaymentdetails.php?id=" . $row['PROOF_ID'] . "&account_id=" . $account_id . "&intermentid=".$row['INTERMENT_ORDER']."'>
                            <td>" . htmlspecialchars($row['PROOF_ID']) . "</td>
                            <td>" . htmlspecialchars($row['INTERMENT_ORDER']) . "</td>
                            <td>" . htmlspecialchars($row['PREPARED_BY']) . "</td>
                            <td>" . htmlspecialchars($row['RESCHEDULE_FILE']) . "</td>
